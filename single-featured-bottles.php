...
$featured_winery = get_field('featured_winery');
                ...
                <div class="tile">
                    <div class="intro tile is-parent is-vertical">
                        <article class="tile is-child">
                            <h3 class="vintage title"><?php echo $vintage; ?></h3>
                            <h1 class="title"><?php echo $title; ?></h1>
                            <h2 class="title"><?php echo $term[0]->name; ?></h2>
                            <h3 class="title"><?php echo $vineyard; ?></h3>
                            <p class="date">Featured on <?php echo $date; ?></p>
                            <div class="content">
                                <?php the_content(); ?>
                            </div>
                        </article>
