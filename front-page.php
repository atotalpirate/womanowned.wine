            ...
            <div class="columns">
                <div class="text column is-half-desktop is-full-touch">
                    <div class="columns is-multiline">
                        <div class="column is-one-third-tablet is-hidden-desktop">
                            <figure class="image is-square">
                                <svg width="676" height="681" viewBox="0 0 676 681" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g class="mobile-masthead-images">
                                        <?php if (have_rows('images')) : while (have_rows('images')) : the_row(); ?>

                                                <image width="100%" height="100%" preserveAspectRatio="xMinYMin slice" xlink:href="<?php the_sub_field('image'); ?>" clip-path="url(#user-space-desktop)" />

                                            <?php endwhile;
                                        else : ?>

                                            <image width="100%" height="100%" preserveAspectRatio="xMinYMin slice" xlink:href="<?php echo $image; ?>" clip-path="url(#user-space-desktop)" />
                ...
                <div class="column is-half">
                    ...
                    <figure class="image is-square is-hidden-touch">
                        <svg width="676" height="681" viewBox="0 0 676 681" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <defs>
